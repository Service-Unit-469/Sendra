                ...
                {actionButtons.map((button) => (
                    <div className="-mt-px flex divide-x divide-neutral-200">
                        <div className="flex w-0 flex-1">
                            <Link to={button.to} className="relative -mr-px inline-flex w-0 flex-1 items-center justify-center rounded-bl border border-transparent py-4 text-sm font-medium text-neutral-800 transition hover:bg-neutral-50 hover:text-neutral-700">
                                {button.icon}
