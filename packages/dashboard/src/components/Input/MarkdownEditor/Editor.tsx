...
import { type colors, Progress } from "./extensions/Progress";
    ...
    <>
      ...
      {modeSwitcher && (
        <div className={"my-3 flex w-full gap-3 rounded-lg bg-neutral-100 p-2"}>
          ...
          <button
            ...
            className={`w-full flex-1 rounded p-2 text-sm font-medium ${mode === "HTML" ? "bg-white" : "hover:bg-neutral-50"} transition ease-in-out`}
          >
            HTML
          </button>{" "}
        </div>
      ...
      >
        ...
        >
          <div className={"sm:col-span-2"}>
            ...
            <div className="mt-1 flex rounded-md shadow-sm">
              <span className="inline-flex items-center rounded-l border border-r-0 border-neutral-300 bg-neutral-50 px-3 text-neutral-500 sm:text-sm">https://</span>
              <input
                type="text"
                autoComplete={"off"}
        ...
        >
          ...
          <div className={"sm:col-span-2"}>
            ...
            <Dropdown
              ...
              selectedValue={watchBar("color") ?? "blue"}
            />
            <AnimatePresence>
        ...
        >
          ...
          <div className={"sm:col-span-2"}>
            ...
            <Dropdown
              ...
              selectedValue={watchButton("color") ?? "blue"}
            />
            <AnimatePresence>
      ...
      <div>
        {mode === "SIMPLE" ? (
          ...
          >
            <label className="block text-sm font-medium text-neutral-700" htmlFor="email-body">
              Email Body
            </label>
            <div className="mt-1 h-full">
              <div className={"flex h-full max-h-[600px] flex-col items-center overflow-y-auto overflow-x-hidden rounded border border-neutral-300 px-3 py-1"}>
                <div className={"sticky top-3 z-10 mt-3 flex flex-col justify-center gap-3 rounded-lg border border-neutral-300 bg-white p-4 shadow-sm"}>
                  <div className={"flex gap-3"}>
                    <div className={"flex"}>
                      <button
                        title={"Align Left"}
                        className={"flex items-center justify-center rounded-l-md border border-neutral-300 bg-white px-3 py-1 text-neutral-800 transition ease-in-out hover:bg-neutral-50"}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      <button
                        title={"Align Center"}
                        className={"flex items-center justify-center border border-neutral-300 bg-white px-3 py-1 text-neutral-800 transition ease-in-out hover:bg-neutral-50"}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      <button
                        title={"Align Right"}
                        className={"flex items-center justify-center rounded-r-md border border-neutral-300 bg-white px-3 py-1 text-neutral-800 transition ease-in-out hover:bg-neutral-50"}
                        onClick={(e) => {
                          e.preventDefault();
          ...
          <div className={"mb-3 sm:grid sm:gap-3 md:grid-cols-1"}>
            <div>
              <label htmlFor="email-body" className="block text-sm font-medium text-neutral-700">
                Email Body
              </label>
              <div className="mt-1 h-full">
                <HTMLEditor
            ...
            <div>
              <label className="block text-sm font-medium text-neutral-700" htmlFor="preview">
                Preview
              </label>
