...
export default function Filter({
  ...
  initialFilter: MetadataFilterType;
  onFilterChange: (filter: MetadataFilterType) => void;
  contacts: Contact[];
  index: number;
  ...
  const fields = useMemo(() => {
    ...
    return [{ name: "Select parameter", value: "" }, { name: "Email", value: "email" }, ...[...fields].map((k) => ({ name: k, value: k }))];
  }, [contacts]);
