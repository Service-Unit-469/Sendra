...
${
        ...
        <tr>
          <td>
            ...
            <p style="font-size: 12px; line-height: 24px; margin: 16px 0; text-align: center; color: rgb(64, 64, 64);">
              ...
              <a href="${APP_URI.startsWith("https://") ? APP_URI : `https://${APP_URI}`}/subscription/?email=${contact.email}">update your preferences</a>.
            </p>
          </td>
        </tr>
      </tbody>
            ...
            ? `
              ...
              <mj-text align="center">
                <p style="color: #a3a3a3; text-decoration: none; font-size: 12px; line-height: 1.7142857;">
                  You received this email because you agreed to receive emails from ${
                    project.name
                  }. If you no longer wish to receive emails like this, please <a style="text-decoration: underline" href="${
                    APP_URI.startsWith("https://") ? APP_URI : `https://${APP_URI}`
                  }/subscription/?email=${contact.email}" target="_blank">update your preferences</a>.
                </p>
              </mj-text>
            `
            : ""
  ...
  public static format({ subject, body, data }: { subject: string; body: string; data: Record<string, string> }) {
    return {
      subject: subject.replace(/\{\{(.*?)}}/g, (_match, key) => {
